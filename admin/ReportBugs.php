    ...
    <div class="container-fluid">
      <div class="col-md-12">
       <div class="card card-cascade narrower z-depth-1">
          <!-- Card image -->
          <div class="view view-cascade pd-5 danger-color narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
              ...
              <table class="table table-hover mb-0 align-middle">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="th-lg"><a href="">Date</a></th>
